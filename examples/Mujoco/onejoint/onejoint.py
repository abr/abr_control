"""
Minimal example using the mujoco interface with a one link arm
controlling a single degree of freedom

To plot the joint angles call the script with True
passed through sys.argv
    python onelink.py True
"""
import glfw
import sys
import numpy as np
...
target = np.array([0.2, 0, 0.3, 0, 0, 0])
