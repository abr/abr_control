...
class InverseKinematics:
    ...
    def generate_path(self, pos, target_pos, n_timesteps=200,
        ...
        self.trajectory = np.zeros((n_timesteps, pos.shape[0]*2))
        ee_track = []
        ee_err = []
        ea_err = []
        ...
        Qd = np.array(transformations.unit_vector(
            transformations.quaternion_from_euler(
                target_pos[3], target_pos[4], target_pos[5], axes='rzyx')))
